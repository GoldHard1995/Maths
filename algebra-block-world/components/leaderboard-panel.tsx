...
const boards: { id: BoardId; label: string }[] = [
  { id: 'words', label: '文字變代數' },
  { id: 'add-subtract', label: '代數式加減' },
  { id: 'multiply-divide', label: '代數式乘除' },
  { id: 'expand', label: '拆括號' },
  { id: 'mixed-expand', label: '括號四則化簡' },
  { id: 'substitute', label: '公式代入' },
  { id: 'sequence', label: '數列代入' },
...
export default function LeaderboardPanel({
  ...
  const [board, setBoard] = useState<BoardId>('words');
