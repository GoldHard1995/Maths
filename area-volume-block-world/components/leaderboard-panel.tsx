...
const boards: { id: BoardId; label: string }[] = [
  { id: 'area-composite', label: '面積與分割填補' },
  { id: 'uniform-cross-section', label: '均勻截面' },
  { id: 'prism-volume', label: '角柱體體積' },
  { id: 'total-surface-area', label: '總表面面積' },
...
export default function LeaderboardPanel({
  ...
  const [board, setBoard] = useState<BoardId>('area-composite');
